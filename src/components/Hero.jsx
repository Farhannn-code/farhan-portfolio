...
import farhanImg from '../assets/Portfolio/farhan.png';
...
const Hero = () => {
  ...
  const developerRoles = [
    ...
    'INTEGRATIONS // SHOPIFY API SPECIALIST',
  ...
  return (
    ...
    >
      ...
      <div ref={contentRef} className="relative z-20 w-full max-w-7xl mx-auto px-6 md:px-12 min-h-screen lg:h-full flex flex-col justify-between pt-24 pb-12">
        ...
        <div className="hero-anim-item flex items-center justify-between w-full">
          <div className="inline-flex items-center gap-2.5 px-4 py-1.5 rounded bg-black/80 backdrop-blur-2xl border border-red-600/40 text-xs font-mono uppercase tracking-widest text-white shadow-2xl">
            ...
            <span className="text-red-500 font-bold tracking-wider">AVAILABLE FOR FULL-STACK OPPORTUNITIES</span>
            <span className="text-white/40">|</span>
            <span className="text-white/80">EXPERIENCE 2024 - 2026</span>
          </div>
          <div className="hidden md:flex items-center gap-2 text-xs font-mono text-white/50 tracking-wider">
            ...
            <span className="px-2 py-0.5 border border-white/20 rounded bg-black/40">2+ YEARS IN PRODUCTION</span>
          </div>
        </div>

        {/* Main Center Cinematic Stage Layout */}
        <div className="grid grid-cols-1 lg:grid-cols-12 items-center gap-8 my-auto py-10 lg:py-0">
          ...
          <div className="lg:col-span-5 flex flex-col items-start space-y-5 text-left">
            ...
            <div className="hero-anim-item flex items-center gap-3">
              <span className="px-2.5 py-0.5 bg-red-600 text-white font-black text-xs rounded tracking-widest shadow-[0_0_20px_rgba(229,9,20,0.8)] animate-pulse">FULL STACK</span>
              <span className="text-white/80 text-xs font-mono tracking-widest uppercase">Laravel • WordPress • Shopify</span>
            </div>
            ...
            <h1 className="hero-anim-item text-5xl md:text-7xl font-black tracking-tighter text-white leading-[0.95] drop-shadow-[0_15px_30px_rgba(0,0,0,0.9)]">
              F. FARHAN <br />
              <span className="inline-block text-[0.86em] text-transparent bg-clip-text bg-gradient-to-r from-red-500 via-rose-600 to-red-700 drop-shadow-[0_0_35px_rgba(220,38,38,0.5)]">
                FULL-STACK
                <span className="block tracking-[-0.035em] text-transparent bg-clip-text bg-gradient-to-r from-red-500 via-rose-600 to-red-700">
                  DEVELOPER
                </span>
              </span>
            </h1>
            ...
            <div className="hero-anim-item flex items-center gap-3 text-xs font-mono text-red-400 font-bold">
              <span className="px-2 py-0.5 bg-red-500/10 border border-red-500/30 rounded text-red-500">CLIENT-FOCUSED</span>
              <span className="text-white/40">•</span>
              <span>Laravel • PHP </span>
              <span className="text-white/40">•</span>
              <span className="text-white/70">REST APIs & CMS</span>
            </div>

            <p className="hero-anim-item text-sm md:text-base text-white/80 font-light leading-relaxed max-w-md drop-shadow">
              Building responsive, scalable web applications and e-commerce experiences with clean code, reliable API integrations, and AI-assisted development workflows.
            </p>
          ...
          <div className="hero-anim-item lg:col-span-3 flex flex-col items-start lg:items-end space-y-4 text-left lg:text-right">
            <div className="p-5 bg-black/80 backdrop-blur-2xl border border-white/15 rounded-xl shadow-2xl max-w-xs">
              <h3 className="text-xs font-mono uppercase tracking-widest text-red-500 font-bold mb-2">Production Focus</h3>
              <p className="text-xs text-white/80 leading-relaxed font-light">
                End-to-end Laravel applications, custom WordPress experiences, Shopify webhook and order APIs, and performance-focused delivery.
              </p>
            </div>
          </div>
      ...
      <header className="absolute top-0 left-0 z-50 w-full px-4 sm:px-6 md:px-8 py-5 md:py-6 pointer-events-auto">
        <div className="w-full max-w-7xl mx-auto grid grid-cols-2 md:grid-cols-[1fr_auto_1fr] items-center gap-4">
          ...
          <nav className="hidden md:flex items-center justify-center gap-4 lg:gap-8 text-[10px] lg:text-xs font-mono uppercase tracking-widest text-white/80">
