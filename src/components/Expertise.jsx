...
const expertiseData = [
  {
    ...
    text: "Responsive Interfaces & User Experience — building mobile-first layouts with React, HTML5, CSS3, JavaScript, Bootstrap, and jQuery.",
    tag: "UI / RESPONSIVE WEB",
    skills: ["React", "HTML5", "CSS3", "JavaScript", "Responsive Design", "WordPress", "Shopify"],
    gradient: "from-[#1f0a0c] via-[#121212] to-[#0a0a0a]"
  },
  {
    number: "02",
    title: "Backend Development",
    text: "Applications, APIs & Database Solutions — developing PHP and Laravel systems with MySQL, authentication workflows, REST APIs, and scalable integrations.",
    tag: "SERVER / DATABASE",
    skills: ["PHP", "Laravel", "MySQL", "REST APIs", "Authentication", "Shopify APIs"],
    gradient: "from-[#1a0809] via-[#111111] to-[#090909]"
  },
  {
    number: "03",
    title: "Web Solutions & Delivery",
    text: "WordPress, Shopify & CMS Solutions — delivering responsive websites, custom themes, plugins, storefronts, and polished client experiences.",
    tag: "CMS / E-COMMERCE",
    skills: ["WordPress", "Shopify", "Custom Themes", "Plugins", "Liquid", "CMS"],
    gradient: "from-[#1d090b] via-[#101010] to-[#080808]"
  },
  {
    number: "04",
    title: "AI-Assisted Development",
    text: "AI Tools, Automation & Faster Workflows — using modern AI to accelerate API writing, debugging, UI exploration, documentation, and refactoring.",
    tag: "AI / PRODUCTIVITY",
    skills: ["ChatGPT", "Codex", "Claude AI", "Cursor AI", "Antigravity"],
      ...
      <div className="relative z-10 max-w-6xl mx-auto w-full space-y-12">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 pb-2">
          ...
          <p className="text-white/60 text-xs md:text-sm font-light leading-relaxed max-w-xs">
            Combining full-stack development, CMS expertise, API integration, and AI-assisted workflows to deliver polished client solutions.
          </p>
        </div>
                ...
                <div className="lg:col-span-7 space-y-4">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {item.skills.map((skill) => (
                      <span key={skill} className="px-2.5 py-1 rounded border border-red-600/25 bg-red-600/10 text-[10px] font-mono uppercase tracking-wider text-red-200 transition-colors group-hover:border-red-500/60 group-hover:bg-red-600/20">
                        {skill}
                      </span>
                    ))}
                  </div>
