...
const skillCategories = [
  { 
    ...
    desc: 'Building responsive, mobile-first interfaces with React that remain usable and consistent across modern browsers and screen sizes.', 
    tag: 'UI / INTERACTION',
    skills: ['React', 'HTML5', 'CSS3', 'JavaScript ES6+', 'Bootstrap', 'jQuery', 'Responsive Design'] 
  },
  { 
    title: 'Backend Development', 
    desc: 'Developing secure server-side functionality, structured databases, REST integrations, authentication flows, and maintainable business logic.', 
    tag: 'SERVER / DATABASE',
    skills: ['PHP', 'MySQL', 'REST APIs', 'Authentication', 'Database Design'] 
  },
  { 
    title: 'Laravel Development', 
    desc: 'Building full-stack Laravel applications with role-based authentication, reporting, API integrations, and reliable MySQL data management.', 
    tag: 'FULL-STACK FRAMEWORK',
    skills: ['Laravel', 'PHP', 'MySQL', 'REST APIs', 'Role-Based Auth'] 
  },
  { 
    title: 'WordPress Development', 
    desc: 'Creating and maintaining content-rich websites with custom themes, plugins, updates, performance tuning, and tailored client functionality.', 
    tag: 'CMS / CUSTOMIZATION',
    skills: ['WordPress', 'Custom Themes', 'Plugins', 'CMS', 'Optimization'] 
  },
  { 
    title: 'Shopify Development', 
    desc: 'Creating responsive e-commerce experiences with Liquid customization and Laravel APIs for webhooks, products, customers, and order processing.', 
    tag: 'E-COMMERCE / LIQUID',
    skills: ['Shopify', 'Liquid', 'Webhooks', 'Order APIs', 'Product Management'] 
  },
];
...
const Skills = () => {
  ...
  return (
    ...
    >
      ...
      <div className="md:hidden absolute top-1/2 mt-[250px] left-1/2 -translate-x-1/2 z-20 flex items-center justify-center gap-2" aria-label="Skill slides">
