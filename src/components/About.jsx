      ...
      <div className="relative z-10 max-w-7xl mx-auto w-full space-y-16">
        ...
        <div className="flex flex-col items-start space-y-4">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded bg-black/80 backdrop-blur-2xl border border-red-600/40 text-xs font-mono uppercase tracking-widest text-white shadow-2xl">
            ...
            <span className="text-red-500 font-bold">ABOUT ME</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
          ...
          >
            ...
            <div className="space-y-5 relative z-10">
              ...
              <p className="text-lg md:text-xl font-medium text-white/90 leading-relaxed">
                I am <span className="text-white font-bold drop-shadow">F. Farhan</span>, a Full Stack Developer from Coimbatore with professional experience delivering Laravel, WordPress, and Shopify solutions.
              </p>
              <p className="text-sm md:text-base text-white/60 font-light leading-relaxed">
                I combine a Mechanical Engineering foundation from Anna University with hands-on web engineering, turning client requirements into responsive interfaces, dependable backend services, and maintainable digital products.
              </p>
            </div>
            
            <div className="pt-8 flex flex-wrap gap-2 relative z-10">
              <span className="px-3.5 py-1.5 rounded bg-white/5 border border-white/10 text-xs font-mono text-white/80">B.E. Mechanical • 2024</span>
              ...
              <span className="px-3.5 py-1.5 rounded bg-white/5 border border-white/10 text-xs font-mono text-white/80">Coimbatore, Tamil Nadu</span>
            </div>
          </div>

          {/* Card 2: Professional Experience Highlight (Span 5) */}
          <div
            ref={addToRefs}
          ...
          >
            ...
            <div className="space-y-5 relative z-10">
              ...
              <div className="flex flex-wrap items-center gap-2">
                <span className="px-2.5 py-1 rounded bg-red-600 text-white text-[10px] font-mono font-bold tracking-widest uppercase shadow-[0_0_18px_rgba(229,9,20,0.45)]">Full Stack Developer</span>
                <span className="text-[10px] font-mono tracking-widest text-white/60 uppercase">ManicMedia • Coimbatore</span>
              </div>
              <ul className="space-y-3.5 text-sm text-white/80 font-light">
                <li className="flex items-start gap-2.5">
                  <span className="text-red-500 font-bold">&#8250;</span>
                  <span><strong className="text-white">Jun 2024 — Aug 2026</strong> • Full-stack web development and client solution delivery.</span>
                </li>
                <li className="flex items-start gap-2.5">
                  <span className="text-red-500 font-bold">&#8250;</span>
                  <span>Built end-to-end <strong className="text-white">Laravel applications</strong> with Admin and Customer role-based authentication.</span>
                </li>
                <li className="flex items-start gap-2.5">
                  <span className="text-red-500 font-bold">&#8250;</span>
                  <span>Delivered <strong className="text-white">WordPress and Shopify solutions</strong>, including themes, plugins, APIs, webhooks, products, customers, and orders.</span>
                </li>
              </ul>
            </div>
          ...
          >
            ...
            <div className="space-y-2 text-left relative z-10">
              ...
              <p className="text-base md:text-lg font-semibold text-white">A client-ready stack spanning custom applications, CMS platforms, and e-commerce.</p>
            </div>
            
            <div className="flex flex-wrap items-center gap-3 relative z-10">
              {['Laravel', 'WordPress', 'Shopify', 'PHP', 'MySQL', 'JavaScript', 'REST APIs'].map((tech, idx) => (
                <span
                  key={idx}
